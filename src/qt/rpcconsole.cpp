                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNPCPathCustom = GetArg("-znpcbackuppath", "");
    ...
    if(!strzNPCPathCustom.empty()) {
        ui->wallet_customznpcbackuppath->setText(QString::fromStdString(strzNPCPathCustom));
        ui->wallet_customznpcbackuppath_label->setVisible(true);
        ui->wallet_customznpcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNPCPathCustom.empty()) && nCustomBackupThreshold > 0) {
