                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zNPC || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending NPC because you wouldn't check it anyway.
    if (context == Context::Send_NPC || context == Context::Send_zNPC) {
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("NPCcoin will close now to finish the encryption process. "
                               ...
                               "your NPCs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
