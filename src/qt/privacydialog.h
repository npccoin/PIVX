...
public:
    ...
    void setZNpcControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzNPC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNPC_clicked();
    void on_pushButtonZNpcControl_clicked();
