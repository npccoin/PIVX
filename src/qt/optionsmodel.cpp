...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NPC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNpcCoinAmount"))
        SoftSetArg("-anonymizenpccoinamount", settings.value("nAnonymizeNpcCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in npccoin.cpp during shotdown to also remove the window positions
