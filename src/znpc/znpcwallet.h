...
#ifndef NPCcoin_ZNPCWALLET_H
#define NPCcoin_ZNPCWALLET_H
...
public:
    CzNPCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNPC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNPC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
