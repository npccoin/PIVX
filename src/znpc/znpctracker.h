...
#ifndef NPCcoin_ZNPCTRACKER_H
#define NPCcoin_ZNPCTRACKER_H
...
public:
    CzNPCTracker(std::string strWalletFile);
    ~CzNPCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNPCWallet* zNPCWallet = NULL);
