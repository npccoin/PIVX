...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NpcCoin Core npccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  npccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded npccoin transaction") + "\n" +
                               "  npccoin-tx [options] -create [commands]   " + _("Create hex-encoded npccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded npccoin transaction
