...
This means one can have an always-on npccoind instance running, and another local npccoind/npccoin-qt instance which connects to this node and receives blocks from it.
