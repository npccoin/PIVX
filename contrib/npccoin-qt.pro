...
RESOURCES += src/qt/npccoin.qrc src/qt/npccoin_locale.qrc

TRANSLATIONS += src/qt/locale/npccoin_bg.ts \
                src/qt/locale/npccoin_de.ts \
                src/qt/locale/npccoin_en.ts \
                src/qt/locale/npccoin_es.ts \
                src/qt/locale/npccoin_fi.ts \
                src/qt/locale/npccoin_fr.ts \
                src/qt/locale/npccoin_it.ts \
                src/qt/locale/npccoin_ja.ts \
                src/qt/locale/npccoin_pl.ts \
                src/qt/locale/npccoin_pt.ts \
                src/qt/locale/npccoin_ru.ts \
                src/qt/locale/npccoin_sk.ts \
                src/qt/locale/npccoin_sv.ts \
                src/qt/locale/npccoin_vi.ts \
                src/qt/locale/npccoin_zh_CN.ts \
                src/qt/locale/npccoin_zh_TW.ts
